...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Nav Item - Borrowed -->
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseBorrowed"
               aria-expanded="true" aria-controls="collapseBorrowed">
                <i class="fas fa-fw fa-cog"></i>
                <span>Borrowed</span>
            </a>
            <div id="collapseBorrowed" class="collapse" aria-labelledby="headingBorrowed"
                 data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
